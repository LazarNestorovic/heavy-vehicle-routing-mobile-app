...
\item \textbf{bcrypt} — algoritam za heširanje lozinki sa ugrađenom "solju"(\emph{salt}) i podesivim faktorom rada, korišćen umesto čuvanja lozinki u čistom tekstu ili prostog heša.
...
\item \textbf{osmium-tool} — alat komandne linije za filtriranje i obradu \texttt{.osm}/\texttt{.osm.pbf} fajlova, korišćen u pripremi geografskih podataka (poglavlje 5.1).
\end{itemize}
