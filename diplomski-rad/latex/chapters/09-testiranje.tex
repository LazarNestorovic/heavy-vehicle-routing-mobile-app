...
\midrule
\endhead
\texttt{internal/algorithm} & 15 & Isključivanje nedopustivih ivica/čvorova, poklapanje Dijkstra/A*, penal za skretanje, ponašanje nad realnim OSM podacima \\
...
Sopstvena Dijkstra/A* implementacija (poglavlje 6.4) je evaluirana nad stvarnim OSM ekstraktom koridora Beograd–Novi Sad (major-roads-only ekstrakt, \texttt{testdata/beograd-novisad-corridor.osm}), učitanim istim \texttt{LoadOSMXML} mehanizmom koji koristi i produkcioni kod. Ekstrakt se učitava u graf od \textbf{38 265 čvorova i 50 705 usmerenih ivica} — dva reda veličine manje od kompletnog nacionalnog Valhalla grafa (898 337 čvorova, poglavlje 5.2), u skladu sa namerom da ovaj modul bude ograničen, transparentan alat za evaluaciju, ne zamena za Valhallu.
